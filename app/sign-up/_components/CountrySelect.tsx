...
const CountrySelect = ({ setUserDetail, userDetail }: any) => {
  ...
  return (
    <div className="w-full relative">
      ...
      {/* Dropdown */}
      {showDropdown && (
        <ul className="absolute top-full left-0 w-full bg-white border border-gray-300 max-h-40 overflow-y-auto overflow-y-scroll scrollbar-thin scrollbar-thumb-slate-500 scrollbar-track-gray-300 rounded-lg z-10">
